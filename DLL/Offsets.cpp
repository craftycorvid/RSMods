...
void Offsets::Initialize() {
	...
	ptr_ModdedPtrCrashFix = { {0x0041C640, baseHandle + 0x0001C8A0} };		// Code | 89 46 1c 89 46 2c 89 7e 28 (opcode after this)
	ptr_IsWindowInFocus = { {0x1251A78, 0x01022a78} };						// Static Memory | 00 00 00 80 01 00 00 00 04 00 00 00 01 00 00 00 (second variable)
	ptr_WindowNotInFocusValue = { {0xEC5D46, baseHandle + 0x00AC5490} };    // Code | c6 05 78 2a 02 01 00 (first opcode)
